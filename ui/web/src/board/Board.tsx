...
export function Board({ workspace, epoch, opened, onOpen, onOpenFiles }: {
  workspace: string; epoch: number; opened: string | null; onOpen: (oid: string | null) => void; onOpenFiles: (path: string) => void
}) {
