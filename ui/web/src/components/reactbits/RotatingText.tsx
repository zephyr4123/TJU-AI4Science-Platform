// 轮换的一句话，从 reactbits 的 RotatingText 捞来（MIT，https://reactbits.dev/text-animations/rotating-text）：
// 输入框里轮换提示能说什么。改装点：cn 用项目的；其余照原样。减少动效时调用方直接给静态一句，不进这里。
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>(
  (
    ...
    return (
      <motion.span className={cn('relative flex flex-wrap whitespace-pre-wrap', mainClassName)} {...rest} layout transition={transition}>
